<?php
/* Smarty version 4.1.1, created on 2022-09-08 17:13:54
  from 'C:\wampp\apache2\htdocs\smartLogistics\view\main\member\agreement.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6319a44298d667_30168695',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a0e7d2796fe7e157d24738eae32139aa5737eddc' => 
    array (
      0 => 'C:\\wampp\\apache2\\htdocs\\smartLogistics\\view\\main\\member\\agreement.tpl',
      1 => 1662624132,
      2 => 'file',
    ),
  ),
...
function content_6319a44298d667_30168695 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '7045110446319a442985fd9_08983092';
?>
<!DOCTYPE html>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!--/ 필수 동의 Table -->
                ...
                <div class="mb-3">
                  ※ 귀하께서는 필수항목 수집·이용에 대한 동의를 <br>
                  거부하실 수 있으나,이는 서비스 제공에 필수적으로 <br>
                  제공되어야 하는 정보이므로, 동의를 거부하실 경우 <br>
                  서비스 이용을 하실 수 없습니다.<br><br>
                </div>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td>
                          <span class="badge bg-label-primary me-2">수집 목적 상실 후 <br>즉시 폐기</span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <!--/ 선택 동의 Table -->
                <div class="mb-3">
                  위 개인정보 수집·이용에 동의합니다(선택)<br><br>
                  동의함 <input type="checkbox" name="option_agree" class="form-check-input"> 
                </div>
                <div class="mb-3">
              ...
              <p class="text-center">
                <span>Copyright © 2022. XOR파이 All Right Reserved.</span>
              </p> 
            </div>
          </div>
          <!-- /Register -->
